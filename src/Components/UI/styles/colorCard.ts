...
export const styleCardPosts: React.CSSProperties = {
  ...
  background: `linear-gradient(to bottom left, rgba(255, 160, 42, 0.5), ${typoColor.subMainBackground} 45%)`,
...
export const styleCardUsers: React.CSSProperties = {
  ...
  boxShadow: '5px 5px 10px rgba(0, 0, 0, 0.05)',
  color: typoColor.white1,
  background: `linear-gradient(to bottom left, rgba(45, 212, 191, 0.5), ${typoColor.subMainBackground} 45%)`,
  border: '2px solid #1e1e1e',
  borderRadius: '14px'
}
export const styleCardApartments: React.CSSProperties = {
  ...
  boxShadow: '5px 5px 10px rgba(0, 0, 0, 0.05)',
  color: typoColor.white1,
  background: `linear-gradient(to bottom left, rgba(248, 113, 113, 0.5), ${typoColor.subMainBackground} 45%)`,
  border: '2px solid #1e1e1e',
  borderRadius: '14px'
}
export const styleCardContracts: React.CSSProperties = {
  ...
  boxShadow: '5px 5px 10px rgba(0, 0, 0, 0.05)',
  color: typoColor.white1,
  background: `linear-gradient(to bottom left, rgba(161, 161, 170, 0.5), ${typoColor.subMainBackground} 45%)`,
  border: '2px solid #1e1e1e',
  borderRadius: '14px'
}
